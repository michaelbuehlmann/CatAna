...
template class RawBinarySink<CartesianRecord<float>>;
template class RawBinarySink<CartesianRecord<double>>;
template class RawBinarySink<SphericalRecord<float>>;
template class RawBinarySink<SphericalRecord<double>>;