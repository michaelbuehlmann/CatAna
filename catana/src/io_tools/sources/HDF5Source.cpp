...
namespace catana{ namespace io {
        ...
        template
        class HDF5Source<CartesianRecord<float>>;

        template
        class HDF5Source<CartesianRecord<double>>;

        template
        class HDF5Source<SphericalRecord<float>>;

        template
        class HDF5Source<SphericalRecord<double>>;
