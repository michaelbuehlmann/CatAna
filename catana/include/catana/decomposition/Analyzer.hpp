...
public:
    Analyzer() = default;
    Analyzer(std::shared_ptr<Source> source, double window_volume);
    ...
    KClkk compute_sfb(unsigned short lmax, unsigned short nmax, double rmax, unsigned int nside, bool verbose);
private:
